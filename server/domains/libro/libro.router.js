...
const addPost = async (req, res) => {
  ...
  if (validationError) {
    log.info('Se entrega al cliente error de validación de add libro');
  ...
  try {
    ...
    log.error(
      'ln 53 libro.controller: Error al guardar proyecto en la base de datos',
    );
